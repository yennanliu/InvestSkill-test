...
xychart-beta
    ...
    y2-axis "成交量 (百萬股)" 0 --> 50
    line {
        name "股價"
        data [577.22, 563.85, 562.20, 557.67, 542.87, 550.25, 562.60, 563.29, 612.91, 582.90]
        lineColor #3b82f6
        pointMarker circle
    }
    bar {
        name "成交量"
        data [28.8, 15.4, 13.1, 14.0, 17.0, 18.9, 15.0, 18.1, 45.5, 21.7]
        yAxisIndex 1
        barColor {
            "06/18": "rgba(16,185,129,0.6)",
            "06/22": "rgba(239,68,68,0.6)",
            "06/23": "rgba(239,68,68,0.6)",
            "06/24": "rgba(239,68,68,0.6)",
            "06/25": "rgba(239,68,68,0.6)",
            "06/26": "rgba(16,185,129,0.6)",
            "06/29": "rgba(16,185,129,0.6)",
            "06/30": "rgba(16,185,129,0.6)",
            "07/01": "rgba(16,185,129,0.6)",
            "07/02": "rgba(239,68,68,0.6)"
        }
    }
```
...
xychart-beta
    ...
    bar {
        name "總營收"
        data [116.6, 134.9, 164.5, 201.0, 215.0]
        barColor #3b82f6
    }
    line {
        name "淨利潤"
        data [23.2, 39.1, 62.4, 60.5, 70.6]
        lineColor #f59e0b
        pointMarker circle
    }
```
...
xychart-beta
    ...
    line {
        name "毛利率"
        data [78.35, 80.76, 81.66, 82.00, 81.94]
        lineColor #3b82f6
        pointMarker circle
    }
    line {
        name "營運利潤率"
        data [24.82, 34.65, 42.18, 41.44, 40.62]
        lineColor #f59e0b
        pointMarker circle
    }
    line {
        name "淨利潤率"
        data [19.89, 29.00, 37.91, 30.08, 32.84]
        lineColor #8b5cf6
        pointMarker circle
    }
```
